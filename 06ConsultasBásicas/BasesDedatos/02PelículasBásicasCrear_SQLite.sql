...
(
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (3, 'La Fiera de mi Niña','Howard HawksI',1938,'2012-03-01',12);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (10, 'El Halcón Maltés','John Huston',1941,'2012-04-01',9);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (16, 'La Fuerza Del Cariño','James L. Brooks',1983,'2010-01-01',18);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (27, 'Vértigo / De entre los Muertos','Alfred Hitchcock',1958,'14/03/2012',6);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (31, 'Melodías de Broadway','Vincente Minnelli',1953,'05/12/2012',10);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (32, 'Pasión de Los Fuertes','John Ford',1946,'01/12/2012',5);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (42, 'Carta de una Desconocida','Max Ophüls',1948,'30/05/2012',8);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (44, 'Cuentos de la Luna Pálida','Kenji Mizoguchi',1953,'01/01/2009',12);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (45, 'La Pasión de Juana de Arco','Carl Theodor Dreyer',1928,'15/08/2012',15.8);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (47, 'El Año Pasado en Marienbad','Alain Resnais',1961,'01/09/2012',7.5);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (56, 'Tiburón','Steven Spielberg',1975,'25/01/2012',16.3);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (57, 'La Reina de África','',1951,'25/03/2012',19);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (58, 'Río Bravo','Howard Hawks',1959,'01/12/2012',3.4);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (61, 'Mujeres al Borde de un Ataque de Nervios','Pedro Almodóvar',1987,'23/01/2012',9.95);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (74, 'Los Niños del Paraíso','Marcel Carné',1945,'12/01/2012',7);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (90, 'El Perro Andaluz','Luis Buñuel',1929,'01/02/2012',8);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (91, 'El Ladrón de Bicicletas','Vittorio de Sica',1948,'16/02/2012',7);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (99, 'El Señor de los Anillos I,II,III','Peter Jackson',2001,'01/11/2012',5);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (100, 'Gilda','Charles Vidor',1946,'01/10/2012',9);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (101, 'El Vampiro de Düsseldorf','Fritz Lang',1931,'01/09/2012',6.7);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (103 ,'¡Qué Bello Es Vivir!','Frank Capra',1946,'31/01/2012',3.99);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (106 ,'El Séptimo Sello','Ingmar Bergman',1956,'01/01/2008',17);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (112 ,'La Gran Ilusión','Jean Renoir',1937,'08/01/2012',12);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (120 ,'Te Querré Siempre','Roberto Rossellini',1953,'04/01/2012',4.75);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (123 ,'Viridiana','Luis Buñuel',1961,'06/07/2012',10.5);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (124 ,'Psicosis','Alfred Hitchcok',1961,'01/06/2012',7.6);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (125 ,'Mi Querida Señorita',null,1971,'05/01/2009',20);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (126 ,'Los Siete Samuráis','Akira Kurosawa',1954,'06/01/2009',19);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (134 ,'El Crepúsculo de los Dioses','Billy Wilder',1950,'01/06/2012',8);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (135 ,'Lo que el Viento se Llevó','Víctor Fleming',1939,'09/01/2008',10.4);
 ...
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (137 ,'El Espíritu de la Colmena','Victor Erice',1973,'04/10/2012',7);
 insert into Peliculas ( Id, Titulo,Director,Agno,FechaCompra,precio)  values (138 ,'Perdición','Billy Wilder',1944,'31/12/2012',4);
...
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('27194787R','Pérez Rodríguez','Antonio','C/La Luna nº 45','922654545','01/02/2002');
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('43996453Y','Medina Martínez','Fernando','C/Los Pilares nº21','922620901','01/05/2008');
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('67385963B','González Hernández','Juan','C/El Sol nº78','922342312','05/09/2010');
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('69241320G','Fernández Armas','José','C/Del Islote nº43','822182813','06/08/2012');
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('71197567D','García Santana','Claudia','C/Fernández nº12','922865295','14/05/2009');
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('72794799Y','Hernández Delgado','Adrián','C/La ola','922683063','16/04/2012');
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('77754689S','Pérez Pérez','María','C/Primera nº 7','922804567','16/04/2012');
...
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('X5363526H','Pérez Rodríguez','Teresa','C/La Luna nº45','922654545','16/04/2007');
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('Y0662510D','Santos Martín','Sara','C/El Quijote nº65','822035853','23/05/2008');
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('Y2113806M','Martínez Abreu','Carlos','C/Las hogueras nº3','922729710','16/09/2010');
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('Z1674471F','Delgado Campos','Pepe','C/El Rosal nº 8','922580181','23/12/2009');
insert into Socios (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('Z9874858C','Rodríguez Heredia','Celia','Plaza Francia','822601369','12/09/2010');
